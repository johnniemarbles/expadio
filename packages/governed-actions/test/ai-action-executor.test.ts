...
const intent: GovernedActionIntent = {
  ...
  sourceEventId: "evt_sr_123",
  sourceEventType: "ServiceRequest.Completed",
  aggregateType: "ServiceRequest",
  aggregateId: "sr_999",
  ruleKey: "rule.service_request.ai_followup_summary",
  executorClass: "AI_ACTION",
  actionKey: "action.ai.summarize",
  idempotencyKey: "evt_sr_123:rule.service_request.ai_followup_summary:AI_ACTION",
  correlationId: "corr_001",
  causationId: "evt_sr_123",
  requestedBySubjectId: "user_agent_01",
  requestedAt: new Date("2026-08-30T12:00:00.000Z"),
  configuration: {
    operation: "SUMMARIZE",
    purpose: "Generate service summary",
    inputReference: "Consulting engagement completed without complications.",
    contextReference: "Client requested follow-up report.",
    promptKey: "prompt.service.summary",
    promptVersion: 1,
