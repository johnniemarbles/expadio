...
export default async function BrandBrainPage() {
  ...
  return <>
    <section className={styles.pageHead}><div><p className={styles.eyebrow}>Brand intelligence</p><h1>Brand Brain</h1><p>Your private operating memory: evidence-backed insights from the work your brand performs.</p></div><div style={{ display: 'flex', gap: 8 }}><Link className={styles.secondaryButton} href="/brain/missions">Open agent missions</Link><Link className={styles.secondaryButton} href="/api/brain/insights">Open insight feed</Link></div></section>
