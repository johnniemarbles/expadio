...
import { AssignmentAuthoring } from '../../../../../components/AssignmentAuthoring';
...
export default async function CourseDetailPage({ params }: { params: Promise<{ id: string }> }) {
  ...
  return (
    <>
      ...
      {value.admin ? <section className={styles.panel}><div className={styles.panelHead}><div><h2>Assignments</h2><p>Create a governed definition, attach its lesson block, and publish it as one guided workflow.</p></div></div><div className={styles.panelBody}><AssignmentAuthoring courseId={summary.courseId} version={version} /></div></section> : null}
