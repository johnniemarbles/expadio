...
export type CommunicationsTabKey = 'overview' | 'senders' | 'domains' | 'templates' | 'suppressions';

export interface PrimaryTabItem {
  id: CommunicationsTabKey;
  label: string;
  tab: string;
  badge?: number;
}
...
const PRIMARY_ITEMS: PrimaryTabItem[] = [
  ...
  { id: 'senders', label: 'Senders', tab: 'senders' },
  { id: 'domains', label: 'Domains', tab: 'domains' },
];

const MORE_ITEMS: MoreMenuItem[] = [
  { id: 'templates', label: 'Templates', tab: 'templates', desc: 'Draft and governed notification templates' },
  { id: 'suppressions', label: 'Suppressions', tab: 'suppressions', desc: 'Organization-level recipient opt-out list' },
];
...
export function CommunicationsNav({
  ...
  readonly activeTab?: CommunicationsTabKey;
  readonly onTabChange?: (tab: CommunicationsTabKey) => void;
  readonly onOpenNewSender?: () => void;
  readonly onOpenNewTemplate?: () => void;
}) {
  ...
  return (
    <nav
      ...
      aria-label="Communications top navigation"
    >
