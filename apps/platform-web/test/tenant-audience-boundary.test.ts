...
test('same-origin Brand fallback is mounted outside Platform chrome', () => {
  assert.equal(existsSync(new URL('../app/brand/api/customers/route.ts', import.meta.url)), true);
