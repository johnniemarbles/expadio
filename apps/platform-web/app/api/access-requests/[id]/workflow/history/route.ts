...
/**
 * The governed trace for an access request's workflow: its append-only stage
 * transitions and immutable decisions, one chronological timeline. A membership
 * read; RLS keeps it within the caller's tenant.
 */
