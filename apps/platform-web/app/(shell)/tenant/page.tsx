...
export default function TenantWorkspacePage() {
  const [tab, setTab] = useState<Tab>('home'); const [location, setLocation] = useState('All permitted locations'); const [work, setWork] = useState(initialWork); const [message, setMessage] = useState('');
