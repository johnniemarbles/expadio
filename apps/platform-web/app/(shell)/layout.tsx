...
export default async function ShellLayout({ children }: { children: React.ReactNode }) {
  ...
  return <Suspense fallback={<p role="status">Loading workspace…</p>}><ShellFrame sections={sections} workspaceContext={workspaceContext} overview={overview}>{children}</ShellFrame></Suspense>;
}
