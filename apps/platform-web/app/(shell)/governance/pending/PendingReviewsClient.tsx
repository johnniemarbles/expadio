...
const inp: React.CSSProperties = { padding: '8px 12px', border: '1px solid var(--theme-border)', borderRadius: "var(--theme-radius-card)", fontSize: 13 };
const badge: React.CSSProperties = { fontSize: 12, fontWeight: 700, color: 'var(--theme-text-secondary)', background: 'var(--theme-surface-muted)', border: '1px solid var(--theme-border)', borderRadius: "var(--theme-radius-card)", padding: '1px 9px', marginLeft: 8, verticalAlign: 'middle' };
