...
- **2026-08-31 — Approved prerequisite and Packs 1–3 implemented in separate PRs; not yet merged.**
  - Pack 1 / AUDIT-SCOPE-PREREQ: owner ChatGPT; [PR #481](https://github.com/johnniemarbles/expadio/pull/481), branch `fix/audit-live-context-pack1`, head `76871b0a0413ecaa221ba969b9ed52e102ebfd0a`; status `handoff` (code/validation complete, draft-state connector blocker). [Core Spine](https://github.com/johnniemarbles/expadio/actions/runs/33358541665) green: 767 core tests and PostgreSQL migration/contract smoke, including non-owner/non-bypass organization isolation. [Platform Web](https://github.com/johnniemarbles/expadio/actions/runs/33358541631) green: typecheck, 364 tests, build. [Workflow Integration](https://github.com/johnniemarbles/expadio/actions/runs/33358541658) green: 67 tests. Live membership resolution is read-only, implicit demo selection/admin default is removed, persisted authorization gates activity reads, and scoped transaction/provenance prevent cross-organization reads. Legacy NULL provenance is retained and hidden rather than guessed.
  - Pack 2: owner ChatGPT; [PR #479](https://github.com/johnniemarbles/expadio/pull/479), branch `fix/audit-real-events-pack2`, head `dcd5b03b1ceb9c0a4d613337f07acbb5939407c0`, base Pack 1; status `handoff`. Two-file diff preserves Pack 1 authorization and removes synthetic rows/fabricated evidence. [Core Spine](https://github.com/johnniemarbles/expadio/actions/runs/33358718919), [Platform Web](https://github.com/johnniemarbles/expadio/actions/runs/33358718854) (378 tests/build), and [Workflow Integration](https://github.com/johnniemarbles/expadio/actions/runs/33358718814) green at this head.
  - Pack 3: owner ChatGPT; [PR #480](https://github.com/johnniemarbles/expadio/pull/480), branch `fix/audit-scope-copy-pack3`, head `1388d3ae5c1b39cec84d49b62c1d07e37424616f`, base Pack 2; status `handoff`. One-page, one-line copy diff. [Core Spine](https://github.com/johnniemarbles/expadio/actions/runs/33358740867), [Platform Web](https://github.com/johnniemarbles/expadio/actions/runs/33358740937), and [Workflow Integration](https://github.com/johnniemarbles/expadio/actions/runs/33358741074) green at this head.
  - **Concrete blocker:** GitHub connector `markPullRequestReadyForReview` fails GraphQL validation on nonexistent `Repository.fullDatabaseId`; #481 remains draft. The same connector action is required for the other drafts. Do not replace PRs, alter protections or force refs to bypass this. Human can mark the existing three PRs ready in GitHub. Then normal review/protections/required CI apply; merge #481 → retarget #479 to main and merge → retarget #480 to main and merge. Recheck head/base and CI after each step. Branch updates here were fast-forward merge commits, not force pushes.
  - No migration deployed to production; CI PostgreSQL is isolated test infrastructure. No real provider send, release gate, checklist completion, vertical unpause, or claim of end-to-end live proof. Later recovery/AI/pack program steps remain pending the sequence and their existing scopes.
